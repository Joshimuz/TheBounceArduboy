Joshimuz Edit
===============
Edited the library to include new 1.2 frame timings, however using the currently 1.2 library results in a game crashing bug currently, will update to official 1.2 when/if fixed
